...
INSERT INTO inventories.products ("CategoryId", "Price", "Name", "Description", "Status", "CreatedOn", "CreatedBy") VALUES
(1, 250000.00, 'Áo Thun Polo Classic', 'Áo thun polo nam chất liệu cotton thoáng mát', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(1, 290000.00, 'Áo Thun Thể Thao', 'Áo thun chất liệu mát, thấm hút mồ hôi tốt', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'), 
(1, 350000.00, 'Áo Sơ Mi Công Sở', 'Áo sơ mi dài tay lịch lãm, chất vải ít nhăn', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'), 
(1, 550000.00, 'Áo Khoác Bomber', 'Áo khoác bomber 2 lớp dày dặn, giữ ấm tốt', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(2, 450000.00, 'Quần Jean Slimfit', 'Quần jean nam dáng ôm vừa vặn, co giãn tốt', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'), 
(2, 380000.00, 'Quần Kaki Công Sở', 'Quần kaki dáng đứng thanh lịch cho nam', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'), 
(2, 390000.00, 'Quần Tây Ống Đứng', 'Quần tây chất liệu cao cấp, co giãn nhẹ, phù hợp đi làm', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(2, 220000.00, 'Quần Short Thể Thao', 'Quần short nam mặc nhà hoặc tập thể thao thoải mái', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'), 
(2, 420000.00, 'Quần Kaki Túi Hộp', 'Quần kaki túi hộp phong cách cá tính, bụi bặm', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(3, 1200000.00, 'Giày Chạy Bộ Ultra', 'Giày thể thao siêu nhẹ, đệm êm ái', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'), 
(3, 1500000.00, 'Giày Sneaker', 'Giày chạy bộ chuyên dụng, đế cao su chống trượt tốt', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(4, 150000.00, 'Ví Da Nam Cầm Tay', 'Ví da bò thật dáng ngang nhỏ gọn', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'), 
(4, 280000.00, 'Thắt Lưng Da Nam Khóa Tự Động', 'Thắt lưng da cao cấp, mặt khóa kim loại chống rỉ', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'), 
(4, 190000.00, 'Nón Lưỡi Trai', 'Nón kết chất vải canvas dày dặn, dễ phối đồ', 'ACT', CURRENT_TIMESTAMP, 'SYSTEM');


INSERT INTO inventories.product_children ("ProductId", "ColorId", "SizeId", "Status", "CreatedOn", "CreatedBy") VALUES
(1, 1, 2, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(1, 2, 3, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(2, 3, 2, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(3, 1, 4, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(4, 4, 2, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(5, 1, 3, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(6, 4, 4, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(7, 4, 2, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(8, 1, 3, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(9, 3, 4, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(10, 2, 5, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(11, 1, 6, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(12, 1, 1, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(13, 1, 1, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM'),
(14, 4, 1, 'ACT', CURRENT_TIMESTAMP, 'SYSTEM');
...
INSERT INTO inventories.stocks ("ProductChildrenId", "Quantity", "Status", "CreatedOn", "CreatedBy") VALUES
...
-- 7. FAVOURITES
INSERT INTO inventories.favorites ("UserId", "ProductChildrenId", "Status", "CreatedOn", "CreatedBy") VALUES
