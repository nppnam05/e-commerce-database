...
-- FAVOURITES
CREATE TABLE inventories.favourites (
    "Id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "UserId" BIGINT,
    "ProductId" BIGINT,
    "Status" VARCHAR(5),
...
ALTER TABLE inventories.favourites
    ADD CONSTRAINT "fk_favourite_user" FOREIGN KEY ("UserId") REFERENCES identity.users("Id"),
    ADD CONSTRAINT "fk_favourite_product" FOREIGN KEY ("ProductId") REFERENCES inventories.products("Id");
